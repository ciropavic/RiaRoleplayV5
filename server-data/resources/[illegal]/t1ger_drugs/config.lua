...
Config.ListOfDrugs = {
	...
	{ drug = 'meth', label = 'Metamfetamin', Enabled = true, BuyPrice = 6000, MinReward = 2, MaxReward = 6 },
	{ drug = 'weed', label = 'Esrar', Enabled = true, BuyPrice = 3500, MinReward = 4, MaxReward = 10 },
}
...
Config.SellDrugsBarText = "Uyuşturucular Satılıyor.."		-- Progress Bar Text for selling drugs
Config.SellDrugsTime = 3						-- time taken to negotiate with NPC in seconds
Config.Enable3DTextToSell = true				-- true = 3D text | false = HelpNotification				-- true = dirty cash | false = normal cash
...
Config.DrugEffects = {
	{ 
		...
		ProgressBarText			= "Kokain Çekiliyor",		-- progress bar text
	...
	{ 
		...
		ProgressBarText			= "Metamfetamin Çekiliyor",				-- progress bar text
	...
	{ 
		...
		ProgressBarText			= "Esrar İçiliyor",				-- progress bar text
		UsableTime 				= 5000,							-- item name in database for usable item
		EffectDuration 			= 30,							-- Duration for effect in seconds
		FasterSprint 			= false,						-- Enable or disable faster sprint while on drugs
		SprintValue 			= 1.2,							-- 1.0 is default
...
Config.DrugConversion = {
	{ 
		...
		ProgressBarText			= "Kokain Paketlemesi => Kokain 10 GR",		-- progress bar text
	...
	{ 
		...
		HighQualityScale		= true,							-- enable/disable scale feature for the drugType
		hqscale					= "hqscale",				 	-- item name in database for hiqh quality scale item
		ProgressBarText			= "Metamfetamin Paketlemesi => Meth 10 GR",		-- progress bar text
		ConversionTime			= 5000,							-- set conversion time in MS.
	},
	{ 
		...
		HighQualityScale		= true,							-- enable/disable scale feature for the drugType
		hqscale					= "hqscale",					-- item name in database for hiqh quality scale item
		ProgressBarText			= "Esrar Paketlemesi => Esrar 10 GR",		-- progress bar text
		ConversionTime			= 5000,							-- set conversion time in MS.
	},
	{ 
		...
		HighQualityScale		= true,							-- enable/disable scale feature for the drugType
		hqscale					= "hqscale",					-- item name in database for hiqh quality scale item
		ProgressBarText			= "Kokain 10 GR => KALİTE KOKO 1 GR",			-- progress bar text
		ConversionTime			= 5000,							-- set conversion time in MS.
	},
	{ 
		...
		HighQualityScale		= true,							-- enable/disable scale feature for the drugType
		hqscale					= "hqscale",					-- item name in database for hiqh quality scale item
		ProgressBarText			= "Meth 10 GR => KALİTE METH 1 GR",			-- progress bar text
		ConversionTime			= 5000,							-- set conversion time in MS.
	},
	{ 
		...
		HighQualityScale		= true,							-- enable/disable scale feature for the drugType
		hqscale					= "hqscale",					-- item name in database for hiqh quality scale item
		ProgressBarText			= "Esrar 10 GR => KALİTE ESRAR 1 GR",			-- progress bar text
		ConversionTime			= 5000,							-- set conversion time in MS.
	},
	{ 
		...
		hqscale					= "hqscale",					-- item name in database for hiqh quality scale item
		ProgressBarText			= "OT 4 GRAM > ORTAK 2G",			-- progress bar text
		ConversionTime			= 5000,							-- set conversion time in MS.
	}
}
