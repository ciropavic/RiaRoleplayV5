...
Config.RequiredPolice = 6					-- required police online for starting heist
Config.EnablePlayerMoneyBag = true			-- enable/disable wearing a bag after cash animation
Config.CooldownTimer = 120					-- in minutes

Config.HackerDevice = "hackerDevice"		-- database name for hacking item
Config.DrillItem = "drill"					-- database name for drill item

-- Reward Settings:
Config.RewardBasedOnCops = true	-- enable or disable rewards based on police online
Config.SafeBoxItem = "jewels"	-- database name for item in safe
Config.MinCashTake = 10				-- this value is multiplied with 100, so 3 means 300. 12 means 1200 and etc.
Config.MaxCashTake = 20				-- this value is multiplied with 100, so 6 means 600. 16 means 1600 and etc.
