...
local function setMenuProperty(id, property, value)
	if id and menus[id] then
		...
		debugPrint(id..' menu değisti: { '..tostring(property)..', '..tostring(value)..' }')
	end
end
...
function SpectatePlayer(player)
	...
	if(Spectating)then
		...
		drawNotification('İzleniyor '..GetPlayerName(player))
	else
		...
		drawNotification('İzleme durdu '..GetPlayerName(player))
	end
end
...
-- Self Menu			
		...
		elseif WarMenu.Button("En yakınındaki Ped Aracına Isınlan") then
			local playerPed = PlayerPedId()
		...
		drawNotification("~y~Isınlanıyor...")
		Citizen.Wait(1000)
		if (NearestVehicle == 0) and (NearestPlane == 0) then
			drawNotification("~r~Arac bulunamadı")
		elseif (NearestVehicle == 0) and (NearestPlane ~= 0) then
			...
			drawNotification("~g~En Yakın Araca Isınlandı!")
		elseif (NearestVehicle ~= 0) and (NearestPlane == 0) then
		...
		elseif WarMenu.Button('Intihar Et') then
			SetEntityHealth(PlayerPedId(), 0)
			drawNotification("~r~Kendini tanrılar tarafından katlettin")
...
-- Véhicule Menu
		...
		elseif WarMenu.IsMenuOpened('PlayerMenu') then
		 ...
		 if WarMenu.MenuButton("Online Oyuncu ~b~>~s~", "OnlinePlayerMenu") then
			end
		...
		elseif WarMenu.IsMenuOpened("PlayerOptionsMenu") then
			...
			if WarMenu.Button('izle', (Spectating and "~g~[SPECTATING]")) then
				...
				TriggerServerEvent("logMenuAdmin", '\nOyuncu Belirle ('..name..')')
			elseif WarMenu.Button('Isınlan') then
...
AddEventHandler("wld:delallveh", function ()
    exports["mythic_notify"]:SendAlert("inform", "Bütün Araçlar Basarıyla Silindi!", 250) 
...
AddEventHandler("wld:delallobject", function ()
    exports["mythic_notify"]:SendAlert("inform", "Bütün Objeler Basarıyla Silindi!", 250) 
...
AddEventHandler("wld:delallpeds", function ()
    exports["mythic_notify"]:SendAlert("inform", "Bütün Pedler Basarıyla Silindi!", 250) 
