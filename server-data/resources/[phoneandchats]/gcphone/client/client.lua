...
RegisterNetEvent('gc:use')
AddEventHandler('gc:use', function(prop_name)
  TooglePhone() 
end)

function TooglePhone() 
  ESX.TriggerServerCallback('gcPhone:phone-check', function(durum)
    if durum ~= nil then
...
--  Events
--====================================================================================
RegisterNetEvent('gcPhon:updatePhone')
AddEventHandler('gcPhon:updatePhone', function(_myPhoneNumber,  _contacts, allmessages)
...
function addContact(display, num, avatar) 
    TriggerServerEvent('gcPhone:addContact', display, num, avatar)
end
...
RegisterNUICallback('addContact', function(data, cb) 
  TriggerServerEvent('gcPhone:addContact', data.display, data.phoneNumber, data.avatar)
end)
RegisterNUICallback('updateContact', function(data, cb)
  TriggerServerEvent('gcPhone:updateContact', data.id, data.display, data.phoneNumber, data.avatar)
end)
RegisterNUICallback('avatarChange', function(data, cb)
  TriggerServerEvent('gcPhone:avatarChange', data.avatar_url)
end)
...
RegisterNUICallback('getPhoneAvatar', function(data, cb)
  ESX.TriggerServerCallback('gcPhone:getAvatar', function(avatarr)
...
RegisterNUICallback('takePhoto', function(data, cb)
  ...
  if hasFocus == true then
    ...
    elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
      exports['screenshot-basic']:requestScreenshotUpload(Config.GeneralPhoto, data.field, function(data)
      local resp = json.decode(data)
      DestroyMobilePhone()
      CellCamActivate(false, false)
      exports["xsound"]:Cal("camera.mp3", true)
...
RegisterNUICallback('ScreentakePhoto', function(data, cb)
	CreateMobilePhone(1)
  CellCamActivate(true, true)
  takePhoto = true
  Citizen.Wait(0)
  if hasFocus == true then
    ...
    elseif IsControlJustPressed(1, 177) then -- CANCEL
      ...
      break
    elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
      exports['screenshot-basic']:requestScreenshotUpload(Config.CameraPhoto, data.field, function(data)
      local resp = json.decode(data)
      DestroyMobilePhone()
      CellCamActivate(false, false)
      exports["xsound"]:Cal("camera.mp3", true)
