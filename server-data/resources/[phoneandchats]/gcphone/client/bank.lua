...
function setBankBalance (value)
      ...
      if ESX.PlayerData.job.grade_name == "boss" then
            ESX.TriggerServerCallback('gcphone:isparasicek', function(data)
                setBankaparas(data)
            end)
      end
end
...
RegisterNUICallback('transferPhoneNumber', function(data)
      TriggerServerEvent('gcPhone:transferPhoneNumber', data.to, data.amountt)
end)
...
AddEventHandler("gcPhone:firstname", function(_firstname)
  ...
  joblabel = ESX.PlayerData.job.grade_name
