...
AddEventHandler('gcPhone:insto_newinstas', function (inap)
  local discord_webhook = GetConvar('discord_webhook', Config.InstagramWeb)
  ...
  local isImg = ext == '.png' or ext == '.pjg' or ext == '.gif' or string.sub(inap.message, -5) == '.jpeg'

    data['embeds'][1]['title'] = inap.forename .." adlı Sarı Sayfalara Yeni Post Attı!"
