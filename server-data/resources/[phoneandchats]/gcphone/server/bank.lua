...
RegisterServerEvent('gcPhone:transferPhoneNumber')
AddEventHandler('gcPhone:transferPhoneNumber', function(to, amountt)
            ...
            if balance <= 0 or balance < tonumber(amountt) or tonumber(amountt) <=
                ...
                TriggerClientEvent('esx:showAdvancedNotification', _source,
                                   ...
                                   'You transfered ~r~$' .. amountt ..
                                       '~s~ to ~r~' .. to .. ' .',
                                   'CHAR_BANK_MAZE', 9)
                TriggerClientEvent('esx:showAdvancedNotification', zPlayer.source , 'Bank',
...
ESX.RegisterServerCallback('gcphone:isparasicek', function(source, cb)
    local xPlayer = ESX.GetPlayerFromId(source)
