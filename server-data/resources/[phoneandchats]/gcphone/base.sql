...
CREATE TABLE `phone_news` (
	`id` INT(11) NOT NULL AUTO_INCREMENT,
	`hex` VARCHAR(50) NULL DEFAULT NULL COLLATE 'utf8_general_ci',
...
CREATE TABLE `phone_settings` (
	`id` INT(11) NOT NULL AUTO_INCREMENT,
	`hex` VARCHAR(255) NOT NULL COLLATE 'utf8mb4_general_ci',
	`app` LONGTEXT NOT NULL COLLATE 'utf8mb4_general_ci',
	`crypto` LONGTEXT NOT NULL COLLATE 'utf8mb4_general_ci',
	PRIMARY KEY (`id`) USING BTREE
)
COLLATE='utf8mb4_general_ci'
ENGINE=InnoDB
...
CREATE TABLE `phone_blockednumber` (
	`id` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sim` (
	`identifier` VARCHAR(50) NOT NULL COLLATE 'utf8mb4_general_ci',
	`phone_number` VARCHAR(10) NULL DEFAULT NULL COLLATE 'utf8mb4_general_ci'
)
COLLATE='utf8mb4_general_ci'
ENGINE=MyISAM
;
