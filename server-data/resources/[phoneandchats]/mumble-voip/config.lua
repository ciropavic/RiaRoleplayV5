...
mumbleConfig = {
	...
	voiceModes = {
		{2.5, "Fısıltı"}, -- Whisper speech distance in gta distance units
		{8.0, "Normal"}, -- Normal speech distance in gta distance units
		{20.0, "Bağırma"}, -- Shout speech distance in gta distance units
	},
	speakerRange = 10.0, -- Speaker distance in gta distance units (how close you need to be to another player to hear other players on the radio or phone)
