...
function WarMenu.CreateMenu(id, title)
	...
	menus[id].titleColor = { r = 100, g = 187, b = 245, a = 255 }
	menus[id].titleBackgroundColor = { r = 0, g = 0, b = 0, a = 170 }
	menus[id].titleBackgroundSprite = nil

	menus[id].menuTextColor = { r = 100, g = 187, b = 245, a = 255 }
	menus[id].menuSubTextColor = { r = 189, g = 189, b = 189, a = 255 }
	menus[id].menuFocusTextColor = { r = 0, g = 0, b = 0, a = 255 }
	menus[id].menuFocusBackgroundColor = { r = 255, g = 255, b = 255, a = 150 }
	menus[id].menuBackgroundColor = { r = 0, g = 0, b = 0, a = 160 }

	menus[id].subTitleBackgroundColor = { r = 100, g = 187, b = 245, a = 160 }
