...
local _BIND_KEY = 121 -- Default: RIGHT CTRL
...
Citizen.CreateThread(function()
    ...
    while true do Citizen.Wait(25)
        ...
        if IsControlJustPressed(0, _BIND_KEY) then
            ...
            if _SMOKE_ON then exports['mythic_notify']:SendAlert('success', '[Yoğun Lastik Dumanı] Açık') else exports['mythic_notify']:SendAlert('error', '[Yoğun Lastik Dumanı] Kapalı') end
