    ...
    if #serverNotes == 0 then
      ...
      if serverNotes[closestNoteId] ~= nil then
        ...
        if distance < 2.0 then
            ...
            DrawText3Ds(serverNotes[closestNoteId]["x"],serverNotes[closestNoteId]["y"],serverNotes[closestNoteId]["z"]-0.4, "~g~"..Controlkey["generalUse"][2].."~s~ okumak için, ~g~"..Controlkey["generalUseSecondaryWorld"][2].."~s~ yok etmek için")
