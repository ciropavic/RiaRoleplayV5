...
function BossMenuManage(id,val)
	local elements = {
		...
		{ label = Lang['view_orders'], value = "view_orders" }
	}
...
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(5)
		if IsControlJustPressed(0, Config.InteractionMenuKey) and plyShopID > 0 and PlayerData.job ~= nil and PlayerData.job.name == 'shop' then
