...
AddEventHandler('sawu_hookers:pay', function(boolean)
    ...
    if (boolean == true) then
        if xPlayer.getMoney() >= Config.BlowjobPrice then
            ...
            TriggerClientEvent('mythic_notify:client:SendAlert', _source, { type = 'inform', text = 'Saksoya bu para gider : ' .. Config.BlowjobPrice ..' $' })
            ...
            TriggerClientEvent('mythic_notify:client:SendAlert', _source, { type = 'error', text = 'Yeterli paran yok fakir adam' })
        ...
        if xPlayer.getMoney() >= Config.SexPrice then
            ...
            TriggerClientEvent('mythic_notify:client:SendAlert', _source, { type = 'inform', text = 'Arabada seks evde on seks: ' .. Config.SexPrice ..' $' })
            -- this adds money to society_nightclub
            if Config.SocietyNightclub then
                TriggerEvent('esx_addonaccount:getSharedAccount', 'society_nightclub', function(account)
