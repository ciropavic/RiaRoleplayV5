...
-- Alarm Settings:
Config.AlarmPayBankMoney = false	-- set to false, if players should pay for alarms with cash instead of bank money
...
-- Search Rewards:
Config.SearchItems = {
	[1] = {item = "rolpaper", name = "Sigara Kağıdı", min = 1, max = 4, chance = 67},
	[2] = {item = "goldwatch", name = "Altın Saat", min = 1, max = 3, chance = 20},
	[3] = {item = "sandwich", name = "Sandwich", min = 1, max = 4, chance = 54},
	[4] = {item = "repairkit", name = "Tamir Kiti", min = 1, max = 3, chance = 85},
	[5] = {item = "donut", name = "Donut", min = 2, max = 7, chance = 54},
	[6] = {item = "coke1g", name = "Kokain 1 Gram", min = 1, max = 3, chance = 94}
}
