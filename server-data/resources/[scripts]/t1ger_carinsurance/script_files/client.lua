...
-- Chat suggestions:
TriggerEvent('chat:addSuggestion', '/sigorta', 'Bir plakada sigortayı kontrol edin veya bir plaka için sigorta kağıdını görüntüleyin / gösterin', {
	{ name="option", help="sunlardan birini seçin: kontrol edin, gösterin veya görüntüleyin" },
	{ name="plate", help="plaka numarasını yazın" }
})
