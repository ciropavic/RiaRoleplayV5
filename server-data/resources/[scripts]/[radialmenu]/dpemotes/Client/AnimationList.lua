...
DP.Shared = {
   ...
   ["tokalaş"] = {"mp_ped_interaction", "handshake_guy_a", "Tokalaş", "tokalaş2", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 3000,
       SyncOffsetFront = 0.9
   }},
   ["tokalaş2"] = {"mp_ped_interaction", "handshake_guy_b", "Tokalaş 2", "tokalaş", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 3000
   }},
   ["sarıl"] = {"mp_ped_interaction", "kisses_guy_a", "Sarıl", "sarıl2", AnimationOptions =
   {
       EmoteMoving = false,
       EmoteDuration = 5000,
       SyncOffsetFront = 1.05,
   }},
   ["sarıl2"] = {"mp_ped_interaction", "kisses_guy_b", "Sarıl 2", "sarıl", AnimationOptions =
   {
       EmoteMoving = false,
       EmoteDuration = 5000,
       SyncOffsetFront = 1.13
   }},
   ["dostum"] = {"mp_ped_interaction", "hugs_guy_a", "Dostum", "dostum2", AnimationOptions =
   {
        SyncOffsetFront = 1.14
   }},
   ["dostum2"] = {"mp_ped_interaction", "hugs_guy_b", "Dostum 2", "dostum", AnimationOptions =
   {
        SyncOffsetFront = 1.14
   }},
   ["hediyever"] = {"mp_common", "givetake1_a", "Hediye Ver Ver", "hediyever2", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 2000
   }},
   ["hediyever2"] = {"mp_common", "givetake1_b", "Hediye Ver 2", "hediyever", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 2000
   }},
   ["beyzbol"] = {"anim@arena@celeb@flat@paired@no_props@", "baseball_a_player_a", "Beyzbol", "beyzbolat"},
   ["beyzbolat"] = {"anim@arena@celeb@flat@paired@no_props@", "baseball_a_player_b", "Beyzbol At", "beyzbol"},
   ["durdimdik"] = {"random@countryside_gang_fight", "biker_02_stickup_loop", "Dur (Dimdik)", "durkorkarak", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["durkorkarak"] = {"missminuteman_1ig_2", "handsup_base", "Dur (Korkarak)", "durdimdik", AnimationOptions =
   {
    EmoteMoving = true,
    EmoteLoop = true,
 }},
   ["punch"] = {"melee@unarmed@streamed_variations", "plyr_takedown_rear_lefthook", "Yumruk At", "punched"},
   ...
   ["slap2"] = {"melee@unarmed@streamed_variations", "plyr_takedown_front_backslap", "Ters Tokat", "slapped2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
       EmoteDuration = 2000,
   }},
   ["slap"] = {"melee@unarmed@streamed_variations", "plyr_takedown_front_slap", "Tokat", "slapped", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
       EmoteDuration = 2000,
...
DP.Dances = {
    ...
    ["çılgındans"] = {"anim@amb@nightclub@lazlow@hi_podium@", "danceidle_hi_06_base_laz", "Çılgın Dans 1", AnimationOptions =
    {
        EmoteLoop = true,
    }},
    ["çılgındans2"] = {"anim@amb@nightclub@lazlow@hi_podium@", "danceidle_hi_06_base_v2_laz", "Çılgın Dans 2", AnimationOptions =
    {
        EmoteLoop = true,
    }},
    ["çılgındans3"] = {"anim@amb@nightclub@lazlow@hi_podium@", "danceidle_hi_11_buttwiggle_b_laz", "Çılgın Dans 3", AnimationOptions =
    {
        EmoteLoop = true,
    }},
    ["çılgındans4"] = {"anim@amb@nightclub@lazlow@hi_podium@", "danceidle_hi_11_buttwiggle_f_laz", "Çılgın Dans 4", AnimationOptions =
    {
        EmoteLoop = true,
    }},
    ["çılgındans5"] = {"anim@amb@nightclub@lazlow@hi_podium@", "danceidle_li_15_sexygrind_laz", "Çılgın Dans 5", AnimationOptions =
    {
        EmoteLoop = true,
    }},
    ["çılgındans6"] = {"anim@amb@nightclub@lazlow@hi_podium@", "danceidle_hi_11_turnaround_laz", "Çılgın Dans 6", AnimationOptions =
    {
        EmoteLoop = true,
    }},
    ["çılgındans7"] = {"anim@amb@nightclub@lazlow@hi_podium@", "danceidle_hi_13_crotchgrab_laz", "Çılgın Dans 7", AnimationOptions =
    {
        EmoteLoop = true,
    }},
    ["dumanalti"] = {"anim@amb@nightclub@lazlow@hi_podium@", "danceidle_hi_11_takebreath_laz", "Duman Altı", AnimationOptions =
    {
        EmoteLoop = true,
    }},
    ["çılgındans8"] = {"anim@amb@nightclub@lazlow@hi_podium@", "danceidle_hi_15_crazyrobot_laz", "Çılgın Dans 8", AnimationOptions =
    {
        EmoteLoop = true,
    }},
    ["çılgındans9"] = {"anim@amb@nightclub@lazlow@hi_podium@", "danceidle_hi_15_lookaround_laz", "Çılgın Dans 9", AnimationOptions =
    {
        EmoteLoop = true,
    }}, 
     ["yaşlıdans"] = {"anim@amb@nightclub@lazlow@hi_podium@", "danceidle_mi_11_hippain_laz", "Yaşlı Dans", AnimationOptions =
    {
        EmoteLoop = true,
    }},
    ...
    ["dans5"] = {"anim@amb@casino@mini@dance@dance_solo@female@var_a@", "med_center", "Dans 5", AnimationOptions =
    {
      ...
      ["strip"] = {"mini@strip_club@pole_dance@pole_a_2_stage", "pole_a_2_stage", "Strip Dans", AnimationOptions =
    {
        EmoteLoop = true
    }},
      ["danskadın9"] = {"anim@amb@nightclub@dancers@crowddance_facedj_transitions@", "trans_dance_facedj_hi_to_li_07_v1_female^1", "Dans (Kadın) 9", AnimationOptions =
    {
        EmoteLoop = true
    }},
      ["danskadın10"] = {"anim@amb@nightclub@dancers@crowddance_facedj_transitions@", "trans_dance_facedj_hi_to_li_07_v1_female^2", "Dans (Kadın) 10", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danskadın11"] = {"anim@amb@nightclub@dancers@crowddance_facedj_transitions@", "trans_dance_facedj_hi_to_li_07_v1_female^3", "Dans (Kadın) 11", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danskadın12"] = {"anim@amb@nightclub@dancers@crowddance_facedj_transitions@", "trans_dance_facedj_hi_to_li_07_v1_female^4", "Dans (Kadın) 12", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danskadın13"] = {"anim@amb@nightclub@dancers@crowddance_facedj_transitions@", "trans_dance_facedj_hi_to_li_07_v1_female^5", "Dans (Kadın) 13", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danskadın14"] = {"anim@amb@nightclub@dancers@crowddance_facedj_transitions@", "trans_dance_facedj_hi_to_li_07_v1_female^6", "Dans (Kadın) 14", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danskadın15"] = {"anim@amb@nightclub@dancers@crowddance_facedj_transitions@", "trans_dance_facedj_hi_to_mi_11_v1_female^1", "Dans (Kadın) 15", AnimationOptions =
    {
        EmoteLoop = true
    }},
      ["danskadın16"] = {"anim@amb@nightclub@dancers@crowddance_facedj_transitions@", "trans_dance_facedj_hi_to_mi_11_v1_female^2", "Dans (Kadın) 16", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danskadın17"] = {"anim@amb@nightclub@dancers@crowddance_facedj_transitions@", "trans_dance_facedj_hi_to_mi_11_v1_female^3", "Dans (Kadın) 17", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danskadın18"] = {"anim@amb@nightclub@dancers@crowddance_facedj_transitions@", "trans_dance_facedj_hi_to_mi_11_v1_female^4", "Dans (Kadın) 18", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danskadın19"] = {"anim@amb@nightclub@dancers@crowddance_facedj_transitions@", "trans_dance_facedj_hi_to_mi_11_v1_female^5", "Dans (Kadın) 19", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danskadın20"] = {"anim@amb@nightclub@dancers@crowddance_facedj_transitions@", "trans_dance_facedj_hi_to_mi_11_v1_female^6", "Dans (Kadın) 20", AnimationOptions =
    {
        EmoteLoop = true
    }},
 
      ["danserkek5"] = {"anim@amb@nightclub@dancers@crowddance_facedj_transitions@", "trans_dance_facedj_hi_to_li_07_v1_male^1", "Dans (Erkek) 5", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danserkek6"] = {"anim@amb@nightclub@dancers@crowddance_facedj_transitions@", "trans_dance_facedj_hi_to_li_07_v1_male^2", "Dans (Erkek) 6", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danserkek7"] = {"anim@amb@nightclub@dancers@crowddance_facedj_transitions@", "trans_dance_facedj_hi_to_li_07_v1_male^3", "Dans (Erkek) 7", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danserkek8"] = {"anim@amb@nightclub@dancers@crowddance_facedj_transitions@", "trans_dance_facedj_hi_to_li_07_v1_male^4", "Dans (Erkek) 8", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danserkek9"] = {"anim@amb@nightclub@dancers@crowddance_facedj_transitions@", "trans_dance_facedj_hi_to_li_07_v1_male^5", "Dans (Erkek) 9", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danserkek10"] = {"anim@amb@nightclub@dancers@crowddance_facedj_transitions@", "trans_dance_facedj_hi_to_li_07_v1_male^6", "Dans (Erkek) 10", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danserkek11"] = {"anim@amb@nightclub@dancers@crowddance_facedj@", "hi_dance_facedj_11_v2_male^1", "Dans (Erkek) 11", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danserkek12"] = {"anim@amb@nightclub@dancers@crowddance_facedj@", "hi_dance_facedj_11_v2_male^2", "Dans (Erkek) 12", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danserkek13"] = {"anim@amb@nightclub@dancers@crowddance_facedj@", "hi_dance_facedj_11_v2_male^3", "Dans (Erkek) 13", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danserkek14"] = {"anim@amb@nightclub@dancers@crowddance_facedj@", "hi_dance_facedj_11_v2_male^4", "Dans (Erkek) 14", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danserkek15"] = {"anim@amb@nightclub@dancers@crowddance_facedj@", "hi_dance_facedj_11_v2_male^5", "Dans (Erkek) 15", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danserkek16"] = {"anim@amb@nightclub@dancers@crowddance_groups_transitions@from_med_intensity", "trans_dance_crowd_mi_to_hi_09_v1_male^1", "Dans (Erkek) 16", AnimationOptions =
    {
        EmoteLoop = true
    }},
      ["danserkek17"] = {"anim@amb@nightclub@dancers@crowddance_groups_transitions@from_med_intensity", "trans_dance_crowd_mi_to_hi_09_v1_male^2", "Dans (Erkek) 17", AnimationOptions =
    {
        EmoteLoop = true
    }},
      ["danserkek18"] = {"anim@amb@nightclub@dancers@crowddance_groups_transitions@from_med_intensity", "trans_dance_crowd_mi_to_hi_09_v1_male^3", "Dans (Erkek) 18", AnimationOptions =
    {
        EmoteLoop = true
    }},
      ["danserkek19"] = {"anim@amb@nightclub@dancers@crowddance_groups_transitions@from_med_intensity", "trans_dance_crowd_mi_to_hi_09_v1_male^4", "Dans (Erkek) 19", AnimationOptions =
    {
        EmoteLoop = true
    }},
      ["danserkek20"] = {"anim@amb@nightclub@dancers@crowddance_groups_transitions@from_med_intensity", "trans_dance_crowd_mi_to_hi_09_v1_male^5", "Dans (Erkek) 20", AnimationOptions =
    {
        EmoteLoop = true
    }},
      ["danserkek21"] = {"anim@amb@nightclub@dancers@crowddance_groups_transitions@from_med_intensity", "trans_dance_crowd_mi_to_hi_09_v1_male^6", "Dans (Erkek) 21", AnimationOptions =
    {
        EmoteLoop = true
    }},
       ["danserkek22"] = {"anim@amb@nightclub@dancers@crowddance_groups@hi_intensity", "hi_dance_crowd_09_v2_male^1", "Dans (Erkek) 22", AnimationOptions =
    {
        EmoteLoop = true
    }},
       ["danserkek23"] = {"anim@amb@nightclub@dancers@crowddance_groups@hi_intensity", "hi_dance_crowd_09_v2_male^2", "Dans (Erkek) 23", AnimationOptions =
    {
        EmoteLoop = true
    }},
       ["danserkek24"] = {"anim@amb@nightclub@dancers@crowddance_groups@hi_intensity", "hi_dance_crowd_09_v2_male^3", "Dans (Erkek) 24", AnimationOptions =
    {
        EmoteLoop = true
    }},
       ["danserkek25"] = {"anim@amb@nightclub@dancers@crowddance_groups@hi_intensity", "hi_dance_crowd_09_v2_male^4", "Dans (Erkek) 25", AnimationOptions =
    {
        EmoteLoop = true
    }},
       ["danserkek26"] = {"anim@amb@nightclub@dancers@crowddance_groups@hi_intensity", "hi_dance_crowd_09_v2_male^5", "Dans (Erkek) 26", AnimationOptions =
    {
        EmoteLoop = true
    }},
       ["danserkek27"] = {"anim@amb@nightclub@dancers@crowddance_groups@hi_intensity", "hi_dance_crowd_09_v2_male^6", "Dans (Erkek) 27", AnimationOptions =
    {
        EmoteLoop = true
    }},
      ["danskadın21"] = {"anim@amb@nightclub@dancers@crowddance_groups@hi_intensity", "hi_dance_crowd_09_v1_female^1", "Dans (Kadın) 21", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danskadın22"] = {"anim@amb@nightclub@dancers@crowddance_groups@hi_intensity", "hi_dance_crowd_09_v1_female^2", "Dans (Kadın) 22", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danskadın23"] = {"anim@amb@nightclub@dancers@crowddance_groups@hi_intensity", "hi_dance_crowd_09_v1_female^3", "Dans (Kadın) 23", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danskadın24"] = {"anim@amb@nightclub@dancers@crowddance_groups@hi_intensity", "hi_dance_crowd_09_v1_female^4", "Dans (Kadın) 24", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danskadın25"] = {"anim@amb@nightclub@dancers@crowddance_groups@hi_intensity", "hi_dance_crowd_09_v1_female^5", "Dans (Kadın) 25", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danskadın26"] = {"anim@amb@nightclub@dancers@crowddance_groups@hi_intensity", "hi_dance_crowd_09_v1_female^6", "Dans (Kadın) 26", AnimationOptions =
    {
        EmoteLoop = true
    }},
     ["danserkek16"] = {"anim@amb@nightclub@dancers@crowddance_facedj@", "hi_dance_facedj_11_v2_male^6", "Dans (Erkek) 16", AnimationOptions =
    {
        EmoteLoop = true
    }},
      ["danskadın7"] = {"anim@amb@casino@mini@dance@dance_solo@female@var_a@", "low_center", "Dans (Kadın) 7", AnimationOptions =
    {
        EmoteLoop = true
    }},
        ["danskadın8"] = {"anim@amb@casino@mini@dance@dance_solo@female@var_b@", "med_center", "Dans (Kadın) 8", AnimationOptions =
    {
        EmoteLoop = true
    }},
 ...
 DP.Emotes = {
    ...
    ["teslimol"] = {"random@arrests@busted", "idle_a", "Teslim Ol", AnimationOptions =
    {
        EmoteLoop = true,
    }},
    ["kahretsin2"] = {"anim@mp_player_intcelebrationfemale@face_palm", "face_palm", "Yüzünü Gizle 2", AnimationOptions =
    {
        EmoteMoving = true,
        EmoteDuration = 8000
    }},
    ["kahretsin"] = {"random@car_thief@agitated@idle_a", "agitated_idle_a", "Yüzünü Gizle", AnimationOptions =
    {
        EmoteMoving = true,
        EmoteDuration = 8000
    }},
    ["kahretsin3"] = {"missminuteman_1ig_2", "tasered_2", "Yüzünü Gizle 3", AnimationOptions =
    {
        EmoteMoving = true,
        EmoteDuration = 8000
    }},
    ["kahretsin4"] = {"anim@mp_player_intupperface_palm", "idle_a", "Yüzünü Gizle 4", AnimationOptions =
    {
        EmoteMoving = true,
        EmoteLoop = true,
    }},
    ...
    ["kucakdansı1"] = {"mp_safehouse", "lap_dance_girl", "Kucak Dansı"},
    ...
    ["selamdur"] = {"anim@mp_player_intincarsalutestd@ds@", "idle_a", "Asker", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = true,
    }},
    ...
    ["arkasındanalkış"] = {"anim@arena@celeb@podium@no_prop@", "dance_a_3rd", "Arkasından Alkış", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = true,
    }},
    ...
    ["t"] = {"missfam5_yoga", "a2_pose", "Titanik", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = true,
    }},
    ...
    ["kucakdansı"] = {"mini@strip_club@private_dance@idle", "priv_dance_idle", "Kucak Dansı 1", AnimationOptions =
    {
        EmoteLoop = true,
    }},
...
["kemertut"] = {"Scenario", "WORLD_HUMAN_COP_IDLES", "Polis Duruşu"},
