...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'gsf', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'gsf', _U('gsf_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'gsf', 'gsf', 'society_gsf', 'society_gsf', 'society_gsf', {type = 'private'})



RegisterServerEvent('esx_gsfjob:getStockItem')
AddEventHandler('esx_gsfjob:getStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_gsf', function(inventory)
...
ESX.RegisterServerCallback('esx_gsfjob:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_gsfjob:putStockItems')
AddEventHandler('esx_gsfjob:putStockItems', function(itemName, count)
...
RegisterServerEvent('esx_gsfjob:getFridgeStockItem')
AddEventHandler('esx_gsfjob:getFridgeStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_gsf_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_gsfjob:getFridgeStockItems', function(source, cb)
...
AddEventHandler('Announceuniouv', function()
	...
	for i=1, #xPlayers, 1 do
		...
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'gsf', '~b~Ad gsf', 'gsf is open!', 'CHAR_ASHLEY', 8)
	end
end)
...
AddEventHandler('Announceunifer', function()
	...
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'gsf', '~b~Ad gsf', 'gsf is close !', 'CHAR_ASHLEY', 8)
	end
end)

RegisterServerEvent('esx_gsfjob:putFridgeStockItems')
AddEventHandler('esx_gsfjob:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_gsfjob:buyItem')
AddEventHandler('esx_gsfjob:buyItem', function(itemName, price, itemLabel)
    ...
    TriggerEvent('esx_addonaccount:getSharedAccount', 'society_gsf', function(account)
...
RegisterServerEvent('esx_gsfjob:craftingCoktails')
AddEventHandler('esx_gsfjob:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('esx_gsfjob:getVaultWeapons', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'society_gsf', function(store)
...
ESX.RegisterServerCallback('esx_gsfjob:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_gsfjob:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_gsfjob:getPlayerInventory', function(source, cb)
