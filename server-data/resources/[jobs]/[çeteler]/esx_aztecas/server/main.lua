...
TriggerEvent('esx_phone:registerNumber', 'aztecas', _U('aztecas_customer'), true, true)
...
RegisterServerEvent('esx_aztecasjob:getFridgeStockItem')
AddEventHandler('esx_aztecasjob:getFridgeStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_aztecas_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_aztecasjob:getFridgeStockItems', function(source, cb)
...
AddEventHandler('Announceuniouv', function()
	...
	for i=1, #xPlayers, 1 do
		...
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'aztecas', '~b~Ad aztecas', 'aztecas is open!', 'CHAR_ASHLEY', 8)
	end
end)
...
AddEventHandler('Announceunifer', function()
	...
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'aztecas', '~b~Ad aztecas', 'aztecas is close !', 'CHAR_ASHLEY', 8)
	end
end)

RegisterServerEvent('esx_aztecasjob:putFridgeStockItems')
AddEventHandler('esx_aztecasjob:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_aztecasjob:buyItem')
AddEventHandler('esx_aztecasjob:buyItem', function(itemName, price, itemLabel)
...
RegisterServerEvent('esx_aztecasjob:craftingCoktails')
AddEventHandler('esx_aztecasjob:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('esx_aztecasjob:getVaultWeapons', function(source, cb)
...
ESX.RegisterServerCallback('esx_aztecasjob:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_aztecasjob:removeVaultWeapon', function(source, cb, weaponName)
