...
TriggerEvent('esx_phone:registerNumber', 'ballas', _U('ballas_customer'), true, true)
...
AddEventHandler('Announceuniouv', function()
	...
	for i=1, #xPlayers, 1 do
		...
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'ballas', '~b~Ad ballas', 'ballas is open!', 'CHAR_ASHLEY', 8)
	end
end)
...
AddEventHandler('Announceunifer', function()
	...
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'ballas', '~b~Ad ballas', 'ballas is close !', 'CHAR_ASHLEY', 8)
	end
end)
...
RegisterServerEvent('esx_ballasjob:craftingCoktails')
AddEventHandler('esx_ballasjob:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('esx_ballasjob:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_ballasjob:removeVaultWeapon', function(source, cb, weaponName)
