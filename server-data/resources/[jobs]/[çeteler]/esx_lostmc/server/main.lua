...
TriggerEvent('esx_phone:registerNumber', 'lostmc', _U('lostmc_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'lostmc', 'lostmc', 'society_lostmc', 'society_lostmc', 'society_lostmc', {type = 'private'})
...
RegisterServerEvent('esx_lostmcjob:getFridgeStockItem')
AddEventHandler('esx_lostmcjob:getFridgeStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_lostmc_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_lostmcjob:getFridgeStockItems', function(source, cb)
...
AddEventHandler('Announceuniouv', function()
	...
	for i=1, #xPlayers, 1 do
		...
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'lostmc', '~b~Ad lostmc', 'lostmc is open!', 'CHAR_ASHLEY', 8)
	end
end)
...
AddEventHandler('Announceunifer', function()
	...
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'lostmc', '~b~Ad lostmc', 'lostmc is close !', 'CHAR_ASHLEY', 8)
	end
end)

RegisterServerEvent('esx_lostmcjob:putFridgeStockItems')
AddEventHandler('esx_lostmcjob:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_lostmcjob:buyItem')
AddEventHandler('esx_lostmcjob:buyItem', function(itemName, price, itemLabel)
...
RegisterServerEvent('esx_lostmcjob:craftingCoktails')
AddEventHandler('esx_lostmcjob:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('esx_lostmcjob:getVaultWeapons', function(source, cb)
...
ESX.RegisterServerCallback('esx_lostmcjob:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_lostmcjob:removeVaultWeapon', function(source, cb, weaponName)
