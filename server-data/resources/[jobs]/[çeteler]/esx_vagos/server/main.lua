...
TriggerEvent('esx_phone:registerNumber', 'vagos', _U('vagos_customer'), true, true)
...
RegisterServerEvent('esx_vagosjob:getFridgeStockItem')
AddEventHandler('esx_vagosjob:getFridgeStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_vagos_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_vagosjob:getFridgeStockItems', function(source, cb)
...
AddEventHandler('Announceuniouv', function()
	...
	for i=1, #xPlayers, 1 do
		...
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'vagos', '~b~Ad vagos', 'vagos is open!', 'CHAR_ASHLEY', 8)
	end
end)
...
AddEventHandler('Announceunifer', function()
	...
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'vagos', '~b~Ad vagos', 'vagos is close !', 'CHAR_ASHLEY', 8)
	end
end)

RegisterServerEvent('esx_vagosjob:putFridgeStockItems')
AddEventHandler('esx_vagosjob:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_vagosjob:buyItem')
AddEventHandler('esx_vagosjob:buyItem', function(itemName, price, itemLabel)
...
RegisterServerEvent('esx_vagosjob:craftingCoktails')
AddEventHandler('esx_vagosjob:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('esx_vagosjob:getVaultWeapons', function(source, cb)
...
ESX.RegisterServerCallback('esx_vagosjob:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_vagosjob:removeVaultWeapon', function(source, cb, weaponName)
