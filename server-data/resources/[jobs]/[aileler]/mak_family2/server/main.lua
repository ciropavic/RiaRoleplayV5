...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'family2', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'family2', _U('family2_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'family2', 'family2', 'society_family2', 'society_family2', 'society_family2', {type = 'private'})



RegisterServerEvent('esx_family2job:getStockItem')
AddEventHandler('esx_family2job:getStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_family2', function(inventory)
...
ESX.RegisterServerCallback('esx_family2job:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_family2job:putStockItems')
AddEventHandler('esx_family2job:putStockItems', function(itemName, count)
...
RegisterServerEvent('esx_family2job:getFridgeStockItem')
AddEventHandler('esx_family2job:getFridgeStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_family2_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_family2job:getFridgeStockItems', function(source, cb)
...
AddEventHandler('Announceuniouv', function()
	...
	for i=1, #xPlayers, 1 do
		...
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'family2', '~b~Ad family2', 'family2 is open!', 'CHAR_ASHLEY', 8)
	end
end)
...
AddEventHandler('Announceunifer', function()
	...
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'family2', '~b~Ad family2', 'family2 is close !', 'CHAR_ASHLEY', 8)
	end
end)

RegisterServerEvent('esx_family2job:putFridgeStockItems')
AddEventHandler('esx_family2job:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_family2job:buyItem')
AddEventHandler('esx_family2job:buyItem', function(itemName, price, itemLabel)
    ...
    TriggerEvent('esx_addonaccount:getSharedAccount', 'society_family2', function(account)
...
RegisterServerEvent('esx_family2job:craftingCoktails')
AddEventHandler('esx_family2job:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('esx_family2job:getVaultWeapons', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'society_family2', function(store)
...
ESX.RegisterServerCallback('esx_family2job:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_family2job:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_family2job:getPlayerInventory', function(source, cb)
