...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'family3', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'family3', _U('family3_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'family3', 'family3', 'society_family3', 'society_family3', 'society_family3', {type = 'private'})



RegisterServerEvent('esx_family3job:getStockItem')
AddEventHandler('esx_family3job:getStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_family3', function(inventory)
...
ESX.RegisterServerCallback('esx_family3job:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_family3job:putStockItems')
AddEventHandler('esx_family3job:putStockItems', function(itemName, count)
...
RegisterServerEvent('esx_family3job:getFridgeStockItem')
AddEventHandler('esx_family3job:getFridgeStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_family3_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_family3job:getFridgeStockItems', function(source, cb)
...
AddEventHandler('Announceuniouv', function()
	...
	for i=1, #xPlayers, 1 do
		...
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'family3', '~b~Ad family3', 'family3 is open!', 'CHAR_ASHLEY', 8)
	end
end)
...
AddEventHandler('Announceunifer', function()
	...
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'family3', '~b~Ad family3', 'family3 is close !', 'CHAR_ASHLEY', 8)
	end
end)

RegisterServerEvent('esx_family3job:putFridgeStockItems')
AddEventHandler('esx_family3job:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_family3job:buyItem')
AddEventHandler('esx_family3job:buyItem', function(itemName, price, itemLabel)
    ...
    TriggerEvent('esx_addonaccount:getSharedAccount', 'society_family3', function(account)
...
RegisterServerEvent('esx_family3job:craftingCoktails')
AddEventHandler('esx_family3job:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('esx_family3job:getVaultWeapons', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'society_family3', function(store)
...
ESX.RegisterServerCallback('esx_family3job:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_family3job:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_family3job:getPlayerInventory', function(source, cb)
