...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'family4', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'family4', _U('family4_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'family4', 'family4', 'society_family4', 'society_family4', 'society_family4', {type = 'private'})



RegisterServerEvent('esx_family4job:getStockItem')
AddEventHandler('esx_family4job:getStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_family4', function(inventory)
...
ESX.RegisterServerCallback('esx_family4job:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_family4job:putStockItems')
AddEventHandler('esx_family4job:putStockItems', function(itemName, count)
...
RegisterServerEvent('esx_family4job:getFridgeStockItem')
AddEventHandler('esx_family4job:getFridgeStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_family4_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_family4job:getFridgeStockItems', function(source, cb)
...
AddEventHandler('Announceuniouv', function()
	...
	for i=1, #xPlayers, 1 do
		...
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'family4', '~b~Ad family4', 'family4 is open!', 'CHAR_ASHLEY', 8)
	end
end)
...
AddEventHandler('Announceunifer', function()
	...
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'family4', '~b~Ad family4', 'family4 is close !', 'CHAR_ASHLEY', 8)
	end
end)

RegisterServerEvent('esx_family4job:putFridgeStockItems')
AddEventHandler('esx_family4job:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_family4job:buyItem')
AddEventHandler('esx_family4job:buyItem', function(itemName, price, itemLabel)
    ...
    TriggerEvent('esx_addonaccount:getSharedAccount', 'society_family4', function(account)
...
RegisterServerEvent('esx_family4job:craftingCoktails')
AddEventHandler('esx_family4job:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('esx_family4job:getVaultWeapons', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'society_family4', function(store)
...
ESX.RegisterServerCallback('esx_family4job:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_family4job:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_family4job:getPlayerInventory', function(source, cb)
