...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'family', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'family', _U('family_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'family', 'family', 'society_family', 'society_family', 'society_family', {type = 'private'})



RegisterServerEvent('esx_familyjob:getStockItem')
AddEventHandler('esx_familyjob:getStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_family', function(inventory)
...
ESX.RegisterServerCallback('esx_familyjob:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_familyjob:putStockItems')
AddEventHandler('esx_familyjob:putStockItems', function(itemName, count)
...
RegisterServerEvent('esx_familyjob:getFridgeStockItem')
AddEventHandler('esx_familyjob:getFridgeStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_family_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_familyjob:getFridgeStockItems', function(source, cb)
...
AddEventHandler('Announceuniouv', function()
	...
	for i=1, #xPlayers, 1 do
		...
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'family', '~b~Ad family', 'family is open!', 'CHAR_ASHLEY', 8)
	end
end)
...
AddEventHandler('Announceunifer', function()
	...
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'family', '~b~Ad family', 'family is close !', 'CHAR_ASHLEY', 8)
	end
end)

RegisterServerEvent('esx_familyjob:putFridgeStockItems')
AddEventHandler('esx_familyjob:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_familyjob:buyItem')
AddEventHandler('esx_familyjob:buyItem', function(itemName, price, itemLabel)
    ...
    TriggerEvent('esx_addonaccount:getSharedAccount', 'society_family', function(account)
...
RegisterServerEvent('esx_familyjob:craftingCoktails')
AddEventHandler('esx_familyjob:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('esx_familyjob:getVaultWeapons', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'society_family', function(store)
...
ESX.RegisterServerCallback('esx_familyjob:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_familyjob:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_familyjob:getPlayerInventory', function(source, cb)
