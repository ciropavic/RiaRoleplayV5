...
Config.AuthorizedVehicles = {
    { name = 'rentalbus',  label = 'Vanilla family Bus' },
}

Config.Blips = {
    
    Blip = {
      Pos     = { x = -2588.246, y = 1902.363, z = 167.501 },
      Sprite  = 181,
      Display = 4,
      Scale   = 0.7,
      Colour  =  1,
...
Config.Zones = {
    ...
    Vaults = {
        Pos   = { x = -2581.406, y = 1891.753, z = 163.088 },
    ...
    Fridge = {
        Pos   = { x = -2585.478, y = 1895.615, z = 166.40 },
...
--[[
    ...
    BossActions = {
        Pos   = { x = -2594.951, y = 1919.021, z = 162.268 },
        Size  = { x = 1.5, y = 1.5, z = 1.0 },
...
--SKINCHANGER CLIENT MAIN.LUA for matching elements
--[[
Config.Uniforms = {
  barman_outfit = {
    male = {
