...
AddEventHandler('esx:onPlayerDeath', function(data)
	...
	if (bone == 31086) then
		multi = 0.0
		print('HEADSHOT')
		TriggerEvent('chatMessage', "MedSystem", {255, 0, 0}, "Kafadan vuruldun")
		bleeding = 5
		area = "Kafa"
	end
	if bone == 24817 or bone == 24818 or bone == 10706 or bone == 24816 or bone == 11816 then
		multi = 1.0
		print('BODYSHOT')
		TriggerEvent('chatMessage', "MedSystem", {255, 0, 0}, "Vücudundan vuruldun")
		bleeding = 2
		area = "Vücut"
	end
...
AddEventHandler('medSystem:near', function(x,y,z, pulse, blood, nameF, nameL, area, bldn)
	...
	if GetDistanceBetweenCoords(x,y,z,a,b,c,false) < 10 then
		timer = 10
		TriggerEvent('chatMessage', "MedSystem", {255,0 , 0}, "^1 [0-5] Ölü ^6[5-15] Hastanede ameliyat edilmeli ^5[15-38] EMS müdahale edebilir ^4[38-55] Polis müdahale edebilir ^2[55+] Sağlıklı")
		cBlood = blood
		cPulse = pulse
		cNameF = nameF
		cNameL = nameL
