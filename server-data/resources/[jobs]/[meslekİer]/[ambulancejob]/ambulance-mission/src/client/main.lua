...
RegisterNetEvent('ambulance_mission:stopgame')
AddEventHandler('ambulance_mission:stopgame', function()
	terminateGame()
end)
...
RegisterNetEvent('ambulance_mission:startgame')
AddEventHandler('ambulance_mission:startgame', function()
	startGame()
end)
