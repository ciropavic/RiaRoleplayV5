...
function WarMenu.CreateMenu(id, title)
	...
	menus[id].subTitle = 'Etkileşim Menüsü'
	...
	menus[id].titleBackgroundColor = { r = 94, g = 119, b = 36, a = 255 }
	menus[id].titleBackgroundSprite = nil

	menus[id].menuTextColor = { r = 255, g = 255, b = 255, a = 255 }
	menus[id].menuSubTextColor = { r = 94, g = 119, b = 36, a = 255 }
	menus[id].menuFocusTextColor = { r = 0, g = 0, b = 0, a = 255 }
	menus[id].menuFocusBackgroundColor = { r = 245, g = 245, b = 245, a = 255 }
	menus[id].menuBackgroundColor = { r = 0, g = 0, b = 0, a = 75 }

	menus[id].subTitleBackgroundColor = { r = 0, g = 0, b = 0, a = 220 }
