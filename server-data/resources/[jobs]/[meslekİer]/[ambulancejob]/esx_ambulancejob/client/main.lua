...
AddEventHandler('esx_ambulancejob:notif', function()
	...
	ReaFaite = true
	ESX.ShowAdvancedNotification('EMS INFO', 'EMS CENTRAL', 'Resüsitasyon yapıldı. \n~g~$150~w~ Hastahane kasasına eklendi\n~g~'..Nombreinter..' müdahale devam ediyor.', 'CHAR_MP_MORS_MUTUAL', 3)
end)
