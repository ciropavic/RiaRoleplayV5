...
function OpenMobileAmbulanceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mobile_ambulance_actions', {
		...
		--	{label = '<span style="color:orange;">📜Faturalandırma<span style="color:white;">', value = 'billing'},
			{label = '<span style="color:green;">🚑EMS Müsait<span style="color:white;">', value = 'ems_ouvert'},
			{label = '<span style="color:red;">🚒EMS Müsait Degil<span style="color:white;">', value = 'ems_ferme'}
		}
	}, function(data, menu)
