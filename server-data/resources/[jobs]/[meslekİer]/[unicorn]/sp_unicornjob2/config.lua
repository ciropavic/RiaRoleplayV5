...
Config.Blips = {
    ...
    Blip = {
      Pos     = { x = -562.246, y = 285.363, z = 29.501 },
      Sprite  = 121,
      Display = 4,
      Scale   = 0.6,
      Colour  = 27,
...
Config.Zones = {
    ...
    Vaults = {
        Pos   = { x = -575.406, y = 291.753, z = 78.188 },
    ...
    Fridge = {
        Pos   = { x = -562.078, y = 289.615, z = 81.30 },
    ...
    BossActions = {
        Pos   = { x = -558.761, y = 288.021, z = 84.38 },
        Size  = { x = 1.5, y = 1.5, z = 1.0 },
        Color = { r = 255, g = 0, b = 0 },
        Type  = 1,
    },
