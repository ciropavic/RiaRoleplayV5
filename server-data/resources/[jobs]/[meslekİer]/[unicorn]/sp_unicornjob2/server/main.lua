...
RegisterServerEvent('Announceuniouvx')
AddEventHandler('Announceuniouvx', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local xPlayers	= ESX.GetPlayers()
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'tequila', '~b~Ad tequila', 'tequila is open!', 'CHAR_ASHLEY', 8)
	end
end)

RegisterServerEvent('Announceuniferx')
AddEventHandler('Announceuniferx', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local xPlayers	= ESX.GetPlayers()
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'tequila', '~b~Ad tequila', 'tequila is close !', 'CHAR_ASHLEY', 8)
	end
end)
