...
RegisterServerEvent('Announceuniouvt')
AddEventHandler('Announceuniouvt', function()
...
RegisterServerEvent('Announceunifert')
AddEventHandler('Announceunifert', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local xPlayers	= ESX.GetPlayers()
	for i=1, #xPlayers, 1 do
