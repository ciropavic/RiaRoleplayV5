...
Config.Blips = {
    ...
    Blip = {
      Pos     = { x = -472.246, y = -97.363, z = 29.501 },
      Sprite  = 121,
      Display = 4,
      Scale   = 0.6,
      Colour  = 27,
...
Config.Zones = {
    ...
    Cloakrooms = {
        Pos   = { x = -1619.701, y = -3020.221, z = -76.10 },
    ...
    Vaults = {
        Pos   = { x = -1617.406, y = -3013.753, z = -76.188 },
    ...
    Fridge = {
        Pos   = { x = -1583.078, y = -3014.615, z = -77.00 },
    ...
    BossActions = {
        Pos   = { x = -1608.451, y = -3011.021, z = -76.18 },
...
-------- SHOPS --------
    ...
    Flacons = {
        Pos   = { x = -1584.61, y = -3012.49, z = -77.00 },
        Size  = { x = 1.0, y = 1.0, z = 1.0 },
        Color = { r = 238, g = 0, b = 0 },
        Type  = 27,
        Items = {
    ...
    NoAlcool = {
        Pos   = { x = -1584.33, y = -3015.17, z = -77.00 },
        Size  = { x = 1.0, y = 1.0, z = 1.0 },
        ...
        Items = {
            ...
            { name = 'powerade',      label = _U('energy'),   price = 20 },
    ...
    Apero = {
        Pos   = { x = -1584.24, y = -3010.28, z = -77.00 },
        Size  = { x = 1.0, y = 1.0, z = 1.0 },
    ...
    Ice = {
        Pos   = { x = -1583.20, y = -3011.96, z = -77.00 },
        Size  = { x = 1.0, y = 1.0, z = 1.0 },
