...
-- polo © License | Discord : https://discord.gg/czW6Jqj
Config.NPCJobEarnings             = {min = 450, max = 600}
...
Config.Zones = {
	...
	TaxiActions = {
		Pos   = {x = 886.155, y = -181.92, z = 73.60},
