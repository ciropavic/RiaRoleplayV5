...
Config.MechanicShops = {
	...
	[3] = { 
		menuPos = {-207.57,-1342.33,30.81},
		price = 999999999,
		storage = {-204.76,-1341.03,34.89},
		workbench = {-227.54,-1327.11,30.89},
		lifts = {
			[1] = {
				entry = {-222.07,-1331.81,30.54,162.45},
				pos = {-222.07,-1331.81,30.54,162.45},
				control = {-222.07,-1331.81,30.54,162.45},
				marker = {enable = true, drawDist = 8.0, type = 36, scale = {x = 0.4, y = 0.4, z = 0.4}, color = {r = 240, g = 52, b = 52, a = 100}},
				minValue = 38.37, maxValue = 40.17,
				currentVeh = nil,
				inUse = false
...
Config.HealthParts = {
	[1] = { label = "Frenler", degName = "brakes", materials = { [1] = {id = 1, qty = 3}, [2] = {id = 2, qty = 2} } },
	[2] = { label = "Radyatör", degName = "radiator", materials = { [1] = {id = 2, qty = 2} } },
	[3] = { label = "El Çantası", degName = "clutch", materials = { [1] = {id = 2, qty = 4} } },
	[4] = { label = "Aktarma", degName = "transmission", materials = { [1] = {id = 6, qty = 4} } },
	[5] = { label = "Elektronik", degName = "electronics", materials = {[1] = {id = 3, qty = 5}, [2] = {id = 4, qty = 3}}},
	[6] = { label = "Tahrik Mili", degName = "driveshaft", materials = { [1] = {id = 2, qty = 4} } },
	[7] = { label = "Yakıt enjektörü", degName = "fuelinjector", materials = { [1] = {id = 7, qty = 4} } },
...
-- Prop Emotes:
Config.PropEmotes = {
	["prop_roadcone02a"] = {label = "Yol Konisi", model = "prop_roadcone02a", bone = 28422, pos = {0.6,-0.15,-0.1}, rot = {315.0,288.0,0.0}},
	["prop_cs_trolley_01"] = {label = "Takım Arabası", model = "prop_cs_trolley_01", bone = 28422, pos = {-0.1,-0.6,-0.85}, rot = {-180.0,-165.0,90.0}},
	["prop_tool_box_04"] = {label = "Alet Kutusu", model = "prop_tool_box_04", bone = 28422, pos = {0.4,-0.1,-0.1}, rot = {315.0,288.0,0.0}},
	["prop_engine_hoist"] = {label = "Motorlu Vinç", model = "prop_engine_hoist", bone = 28422, pos = {0.0,-0.5,-1.3}, rot = {-195.0,-180.0,180.0}}
}
