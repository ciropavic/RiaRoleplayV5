...
RegisterServerEvent('renfort2')
AddEventHandler('renfort2', function(coords, raison)
	...
	for i = 1, #xPlayers, 1 do
		...
		if thePlayer.job.name == 'sheriff' then
			TriggerClientEvent('renfort2:setBlip', xPlayers[i], coords, _raison)
		end
	end
end)
...
TriggerEvent('esx_addons_gcphone:registerNumber', 'sheriff', _U('alert_sheriff'), true, true)
