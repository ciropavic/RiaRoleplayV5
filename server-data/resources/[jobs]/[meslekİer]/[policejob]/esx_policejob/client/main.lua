...
function OpenCloakroomMenu()
	...
	elseif grade == 'lieutenant3' then
		table.insert(elements, {label = _U('police_wear'), value = 'lieutenant3_wear'})
	elseif grade == 'lieutenant4' then
		table.insert(elements, {label = _U('police_wear'), value = 'lieutenant4_wear'})
...
RegisterNetEvent("police:RecieveMenu") -- For opening the emote menu from another resource.
AddEventHandler("police:RecieveMenu", function()
...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
		...
		if data.current.value == 'citizen_interaction' then
			...
			if PlayerData.job and PlayerData.job.name == 'police' and PlayerData.job.grade_name == 'lieutenant3' or PlayerData.job.grade_name == 'lieutenant4'   or PlayerData.job.grade_name == 'boss' then
...
AddEventHandler('renfort:setBlip', function(coords, raison)
	if raison == 'petit' then
		...
		ESX.ShowAdvancedNotification('LSPD DURUM', '~b~Takviye talebi', 'Takviye talebi talep edildi.\nKod: ~g~CODE-2\n~w~Importance: ~g~Yardım lazım.', 'CHAR_CALL911', 8)
		Wait(1000)
...
AddEventHandler('police:InfoService', function(service, nom)
	if service == 'prise' then
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		ESX.ShowAdvancedNotification('LSPD DURUM', '~b~Mesai Durumu', 'Memur: ~g~'..nom..'\n~w~Kod: ~g~10-8\n~w~Bilgi: ~g~Mesaiye başladım', 'CHAR_CALL911', 8)
		Wait(1000)
		PlaySoundFrontend(-1, "End_Squelch", "CB_RADIO_SFX", 1)
