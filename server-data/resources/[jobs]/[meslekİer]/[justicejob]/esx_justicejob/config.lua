...
config.jobname = 'justice' -- which job to use the menu?
...
Config.PoliceStations = {
	...
	LSPD = {
		...
		Blip = {
			Coords  = vector3(244.1, -1074.5, 29.7),
			Sprite  = 181,
			Display = 4,
			Scale   = 0.6,
			Colour  = 81
		...
		Cloakrooms = {
			vector3(252.6, -1099.8, 36.15)
		},

		Armories = {
			vector3(248.7, -1099.00, 36.15)
		},

		Vehicles = {
			{
				Spawner = vector3(252.6, -1072.4, 28.7),
				InsideShop = vector3(251.5, -1070.5, 29.30),
				SpawnPoints = {
					{coords = vector3(254.4, -1062.3, 29.30), heading = 270.0, radius = 6.0},
					{coords = vector3(254.4, -1062.3, 29.30), heading = 270.0, radius = 6.0},
					{coords = vector3(254.4, -1062.3, 29.30), heading = 270.0, radius = 6.0},
					{coords = vector3(254.4, -1062.3, 29.30), heading = 270.0, radius = 6.0}
				}
		...
		Helicopters = {
			{
				...
				SpawnPoints = {
					{ coords = vector3(449.5, -981.2, -99.6), heading = 92.6, radius = 10.0 }
				}
			}
		},

		BossActions = {
			vector3(241.4, -1100.2, 36.13)
		}
...
Config.AuthorizedVehicles = {
	...
	recruit = {
		    {model = 'baller4', label ='Baller Jeep', price = 1000},
			{model = 'asea2', label='Sedan Asea', price = 500},
			{model = 'washington', label='Classin Washington', price = 1000}
	},

	officer = {
		{model = 'baller4', label ='Baller4', price = 1000},
		{model = 'asea2', label='Sedan Asea', price = 500},
		{model = 'washington', label='Classin Washington', price = 1000}
	},
 ...
 lieutenant2 = {
	...
	lieutenant = {
		...
		{model = 'asea2', label='Sedan Asea', price = 500},
		{model = 'washington', label='Classin Washington', price = 1000},
		{model = 'cognosenti', label='Makam Aracı Sedan', price = 1000}
	},
	...
	boss = {
		...
		{model = 'washington', label='Classin Washington', price = 1000},
		{model = 'cognosenti', label='Makam Aracı Sedan',price = 1000},
		{model = 'stafford', label='Makam Aracı Classic', price = 3000}
	},
}
