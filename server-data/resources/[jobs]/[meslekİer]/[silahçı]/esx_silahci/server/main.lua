...
TriggerEvent('esx_phone:registerNumber', 'silahci', _U('silahci_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'silahci', 'silahci', 'society_silahci', 'society_silahci', 'society_silahci', {type = 'private'})
...
AddEventHandler('esx_silahcijob:getStockItem', function(itemName, count)
  ...
  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_silahci', function(inventory)
...
RegisterServerEvent('esx_silahcijob:getFridgeStockItem')
AddEventHandler('esx_silahcijob:getFridgeStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_silahci_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_silahcijob:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('AnnounceuniouvAmmu')
AddEventHandler('AnnounceuniouvAmmu', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local xPlayers	= ESX.GetPlayers()
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'Silahçı', 'Emre Silahçı', 'Silahçı Açık!', 'CHAR_AMMUNATION', 8)
	end
end)

RegisterServerEvent('AnnounceuniferAmmu')
AddEventHandler('AnnounceuniferAmmu', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local xPlayers	= ESX.GetPlayers()
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'Silahçı', 'Emre Silahçı', 'Silahçı Kapalı!', 'CHAR_AMMUNATION', 8)
	end
end)

RegisterServerEvent('esx_silahcijob:putFridgeStockItems')
AddEventHandler('esx_silahcijob:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_silahcijob:buyItem')
AddEventHandler('esx_silahcijob:buyItem', function(itemName, price, itemLabel)
    ...
    TriggerEvent('esx_addonaccount:getSharedAccount', 'society_silahci', function(account)
...
RegisterServerEvent('esx_silahcijob:craftingCoktails')
AddEventHandler('esx_silahcijob:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('esx_silahcijob:getVaultWeapons', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'society_silahci', function(store)
...
ESX.RegisterServerCallback('esx_silahcijob:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_silahcijob:removeVaultWeapon', function(source, cb, weaponName)
