...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'silahci2', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'silahci2', _U('silahci2_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'silahci2', 'silahci2', 'society_silahci2', 'society_silahci2', 'society_silahci2', {type = 'private'})



RegisterServerEvent('esx_silahci2job:getStockItem')
AddEventHandler('esx_silahci2job:getStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_silahci2', function(inventory)
...
ESX.RegisterServerCallback('esx_silahci2job:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_silahci2job:putStockItems')
AddEventHandler('esx_silahci2job:putStockItems', function(itemName, count)
...
RegisterServerEvent('esx_silahci2job:getFridgeStockItem')
AddEventHandler('esx_silahci2job:getFridgeStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_silahci2_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_silahci2job:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('AnnounceuniouvAmmun')
AddEventHandler('AnnounceuniouvAmmun', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local xPlayers	= ESX.GetPlayers()
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'Silahçı', 'Makaveli Silahçı', 'Silahçı Açık!', 'CHAR_AMMUNATION', 8)
	end
end)

RegisterServerEvent('AnnounceuniferAmmun')
AddEventHandler('AnnounceuniferAmmun', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local xPlayers	= ESX.GetPlayers()
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'Silahçı', 'Makaveli Silahçı', 'Silahçı Kapalı!', 'CHAR_AMMUNATION', 8)
	end
end)

RegisterServerEvent('esx_silahci2job:putFridgeStockItems')
AddEventHandler('esx_silahci2job:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_silahci2job:buyItem')
AddEventHandler('esx_silahci2job:buyItem', function(itemName, price, itemLabel)
    ...
    TriggerEvent('esx_addonaccount:getSharedAccount', 'society_silahci2', function(account)
...
RegisterServerEvent('esx_silahci2job:craftingCoktails')
AddEventHandler('esx_silahci2job:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('esx_silahci2job:getVaultWeapons', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'society_silahci2', function(store)
...
ESX.RegisterServerCallback('esx_silahci2job:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_silahci2job:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_silahci2job:getPlayerInventory', function(source, cb)
