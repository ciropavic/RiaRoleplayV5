	...
	while true do
		...
		if DoesEntityExist(cachedData["storeOwner"]) then
			...
			if dstCheck < 3.0 then
				...
				local displayText = not IsEntityDead(cachedData["storeOwner"]) and "Balığı satmak için ~INPUT_CONTEXT~ tuşuna bas." or "Satıcı öldüğünden dolayı balıkları satamazsın!"
