Locales['en'] = {
  ...
  -- Salary related
  ['received_salary'] = 'Maaşınız yatırıldı : ~g~$%s~s~',
  ['received_help'] = 'Refah çekinizi aldınız: ~g~$%s~s~',
  ['company_nomoney'] = 'Çalıştığınız şirket maaşınızı ödeyemeyecek kadar zayıf',
  ['received_paycheck'] = 'Alınan maaş çeki',
  ['bank'] = 'RiaV Bank',
  ['account_bank'] = 'Banka',
  ...
  -- Commands
  ['command_car'] = 'Araç spawnla',
  ['command_car_car'] = 'Arac adını yaz ya da hash seç birini',
  ['command_cardel'] = 'Yakındaki aracı sil',
  ['command_cardel_radius'] = 'İsteğe bağlı, belirtilen yarıçap içindeki her aracı sil',
  ['command_clear'] = 'Konusmayi temizle',
  ['command_clearall'] = 'Tüm oyuncular için sohbeti temizle',
  ['command_clearinventory'] = 'Oyuncu envanterini temizle',
  ['command_clearloadout'] = 'Oyuncu dizilişini temizle',
  ['command_giveaccountmoney'] = 'Hesaba para verme komutu',
  ['command_giveaccountmoney_account'] = 'Geçerli hesap adları',
  ['command_giveaccountmoney_amount'] = 'Eklenecek miktar',
  ['command_giveaccountmoney_invalid'] = 'Geçersiz hesap adı',
  ['command_giveitem'] = 'Bir oyuncuya bir eşya ver',
  ['command_giveitem_item'] = 'İtem Adı',
  ['command_giveitem_count'] = 'İtem Miktarı',
  ['command_giveweapon'] = 'Bir oyuncuya bir silah ver',
  ['command_giveweapon_weapon'] = 'Silah Adı',
  ['command_giveweapon_ammo'] = 'Oyuncu zaten o silaha sahip',
  ['command_giveweapon_hasalready'] = 'Silah bileşeni vermek',
  ['command_giveweaponcomponent'] = 'Bileşen verme komutu',
  ['command_giveweaponcomponent_component'] = 'Bileşen Adı',
  ['command_giveweaponcomponent_invalid'] = 'Geçersiz silah bileşeni',
  ['command_giveweaponcomponent_hasalready'] = 'Oyuncu zaten bu silah bileşenine sahip',
  ['command_giveweaponcomponent_missingweapon'] = 'Oyuncu o silaha sahip değil',
  ['command_save'] = 'Bir oyuncuyu veritabanına kaydet',
  ['command_saveall'] = 'Tüm oyuncuları veritabanına kaydet',
  ['command_setaccountmoney'] = 'Bir oyuncu için hesap parası ayarla',
  ['command_setaccountmoney_amount'] = 'Belirlenecek para miktarı',
  ['command_setcoords'] = 'Koordinatlara ışınlanma',
  ...
  ['command_setjob_job'] = 'İş adı',
  ['command_setjob_grade'] = 'İş değeri',
  ['command_setjob_invalid'] = 'İş, derece veya her ikisi de geçersiz',
  ['command_setgroup'] = 'Oyuncu grubu ayarla',
  ['command_setgroup_group'] = 'Grup ismi',
  ['commanderror_argumentmismatch'] = 'Bağımsız değiken uyumsuzluğu (pas geçildi %s, istendi %s)',
  ['commanderror_argumentmismatch_number'] = 'Bağımsız değişken #% s tür uyuşmazlığı (geçirilen dize, istenen sayı)',
  ['commanderror_invaliditem'] = 'Geçersiz item adı',
  ['commanderror_invalidweapon'] = 'Geçersiz Silah',
  ['commanderror_console'] = 'Bu komut konsoldan çalıştırılamaz',
  ...
  ['commandgeneric_playerid'] = 'Oyuncu kimliği',
