...
function StopTheoryTest(success)
	...
	if success then
		...
		exports['mythic_notify']:SendAlert('success', 'Testi geçtin')
	else
		exports['mythic_notify']:SendAlert('error', 'Testi geçemedin')
	end
end
	...
	while true do
		...
		if CurrentTest == 'drive' then
			...
			if Config.CheckPoints[nextCheckPoint] == nil then
				...
				exports['mythic_notify']:SendAlert('error', 'Sürüş Testi Tamamlandı')
