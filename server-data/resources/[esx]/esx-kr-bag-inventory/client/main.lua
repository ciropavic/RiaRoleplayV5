...
function Bag()
    ...
    table.insert(elements, {label = 'Obje koy', value = 'put'})
    table.insert(elements, {label = 'Obje al', value = 'take'})
    table.insert(elements, {label = 'Çantayı at', value = 'drop'})
    ...
    while true do
        ...
        for i=1, #Bags, 1 do
            ...
            if GetDistanceBetweenCoords(playercoords, Bags[i].id.coords.x, Bags[i].id.coords.y, Bags[i].id.coords.z, true) <= 1.5 and not HasBag then
                ...
                Draw3DText(Bags[i].id.coords.x, Bags[i].id.coords.y, Bags[i].id.coords.z + 0.45, '~g~[E]~w~ koymak için')
                Draw3DText(Bags[i].id.coords.x, Bags[i].id.coords.y, Bags[i].id.coords.z + 0.35, '~o~[N]~w~ aramak için')
                ...
                if IsControlJustReleased(0, Keys['E']) then
                    ...
                    ESX.Game.DeleteObject(1626933972, coords2)
                end
                ...
                if IsControlJustReleased(0, Keys['N']) then
                    ...
                    wait = 5
                    Draw3DText(Bags[i].id.coords.x, Bags[i].id.coords.y, Bags[i].id.coords.z + 0.45, '~g~[E]~w~ Çantayı almak için')
                    Draw3DText(Bags[i].id.coords.x, Bags[i].id.coords.y, Bags[i].id.coords.z + 0.35, '~o~[N]~w~ Aramak için')
