---------------- MADE BY TEFO KRAL KODLADIKMI KODLADIK REİS DEĞİŞTİRİP SATANIN AMINA KOYAYIM EMEK VERDİM "ŞAKA LAN FİVEM DOCDAN HAZIR KOD SATIRINI DEĞİŞTİRDİM AMA SİZE YARDIMCI OLACAKTIR"  ---------------------------------------
...
Citizen.CreateThread(function()
    while true do
        ...
        Wait(100)
        N_0x4757f00bc6323cfe(GetHashKey("WEAPON_SMG"), 0.25)
        Wait(100)
        ...
        Wait(100)
        N_0x4757f00bc6323cfe(GetHashKey("WEAPON_SAWNOFFSHOTGUN"), 0.0001)
        Wait(100)
    end
end)
