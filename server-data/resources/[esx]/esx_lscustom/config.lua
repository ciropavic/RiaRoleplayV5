...
Config.Zones = {
	...
	ls2 = {
		Pos   = { x = -211.53, y = -1324.18, z = 30.44},
		Size  = {x = 5.0, y = 5.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls3 = {
		Pos   = { x = -198.81, y = -1318.82, z = 26.73},
		Size  = {x = 5.0, y = 5.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
