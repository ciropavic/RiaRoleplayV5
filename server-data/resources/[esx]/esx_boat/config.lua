...
Config.Vehicles = {
	{model = 'seashark', label = 'Seashark (Random Color)', price = 75000},
	{model = 'seashark3', label = 'Seashark (Dark Blue)', price = 75000},
	{model = 'suntrap', label = 'Suntrap', price = 180000},
	{model = 'jetmax', label = 'Jetmax', price = 300000},
	{model = 'tropic2', label = 'Tropic', price = 90000},
	{model = 'dinghy2', label = 'Dinghy (Black)', price = 35000},
	{model = 'dinghy', label = 'Dinghy 2 (Random Color)', price = 60000},
	{model = 'speeder', label = 'Speeder', price = 350000},
	{model = 'squalo', label = 'Squalo (Random Color)', price = 220000},
	{model = 'toro', label = 'Toro', price = 400000},
	{model = 'predator', label = 'Polis Botu', price = 99999999}
}