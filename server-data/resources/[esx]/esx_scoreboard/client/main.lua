...
function UpdatePlayerTable(connectedPlayers)
	...
	local ambulance, police, taxi, mechanic, cardealer, justice, players = 0, 0, 0, 0, 0, 0, 0
	...
	SendNUIMessage({
		...
		jobs   = {ambulance = ambulance, police = police, taxi = taxi, mechanic = mechanic, cardealer = cardealer, justice=justice, player_count = players}
	})
...
RegisterCommand('skorboard',function(source, args, user)
			ToggleScoreBoard()
